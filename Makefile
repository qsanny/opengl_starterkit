...
COMPRESS      = gzip -9f
DISTNAME      = tp11.0.0
DISTDIR = /home7/as855970/TP1-MGSI/starterKit2022/starterKit/.tmp/tp11.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS) -lglut -lGLU /usr/lib/x86_64-linux-gnu/libQt5Gui.so /usr/lib/x86_64-linux-gnu/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
distdir: FORCE
	...
	$(COPY_FILE) --parents face.h halfEdge.h mesh.h objfile.h vertex.h $(DISTDIR)/
	$(COPY_FILE) --parents face.cpp halfEdge.cpp main.cpp mesh.cpp objfile.cpp vertex.cpp $(DISTDIR)/
